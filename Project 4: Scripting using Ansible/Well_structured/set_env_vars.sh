...
echo
read -p "Enter the Ansible host (Private IP): " ANSIBLE_HOST
...
VARIABLES=("APP_NAME" "RUBY_VERSION" "POSTGRES_DEPLOY_PASSWORD" "SECRET_KEY_BASE" "RAILS_MASTER_KEY" "ANSIBLE_HOST" "ANSIBLE_USER" "ANSIBLE_SSH_PRIVATE_KEY_FILE")
